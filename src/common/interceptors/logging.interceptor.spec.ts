...
describe('LoggingInterceptor', () => {
  ...
  it('should reuse existing X-Request-Id from request headers', async () => {
  ...
  it('should log incoming request to request log file', async () => {
    const context = createMockContext();
    const next: CallHandler = { handle: () => of(null) };
  ...
  it('should log successful response to response log file', async () => {
    const context = createMockContext();
  ...
  it('should log failed response to response log file', async () => {
    const context = createMockContext();
